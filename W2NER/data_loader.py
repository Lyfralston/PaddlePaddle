...
# >>>>>>    bert_inputs = torch.nn.utils.rnn.pad_sequence(bert_inputs, True)  # modified!
    ...
    dis_mat = paddle.zeros(shape=(batch_size, max_tok, max_tok), dtype='int64')
...
class RelationDataset(paddle.io.Dataset):
    ...
    def __init__(self, bert_inputs, grid_labels, grid_mask2d, pieces2word,
        dist_inputs, sent_length, entity_text):
    ...
    def __getitem__(self, item):
        return paddle.to_tensor(data=self.bert_inputs[item], dtype='int64'), \
               ...
               paddle.to_tensor(data=self.dist_inputs[item], dtype='int64'), \
