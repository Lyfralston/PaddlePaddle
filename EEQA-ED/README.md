...
```bash
>>> . scripts/train.sh config/ace05-en/EEQA_ED_ace05-en_roberta-large.jsonnet
```
It can be downloaded from  [BaiduYun](https://pan.baidu.com/s/190fs4qnhh-6JnXEC29hbtg?pwd=dyw0),  keyword is: dyw0. You should unzip and put it in the main directory.
